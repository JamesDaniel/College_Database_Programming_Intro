...
genre VARCHAR2(20) NOT NULL CONSTRAINT genre_ck CHECK (genre IN('ELECTRIC','DANCE','POP','JAZZ')),
numOfViews NUMBER(9),
...
MemID NUMBER(6),
SongID NUMBER(6),
rating NUMBER(1) CONSTRAINT rating_ck CHECK (rating > 0 AND rating < 6),
...
CREATE TABLE Pages (
PageID NUMBER(6),
PageType VARCHAR2(10) CONSTRAINT page_type_ck CHECK (PageType IN ('BUSINESS','USER','EVENT','BAND')),
